...
const posts = [
  {
    ...
    content: [
      ...
      { type: 'paragraph', line: 'Acabei de subir mais um projeto no meu portifa. É um projeto que fiz no NLW Return, evento da Rocketseat. O nome do projeto é DoctorCare 🚀'},
